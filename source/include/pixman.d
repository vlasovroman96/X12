 ...
 * Fixpoint numbers
 */
alias 			pixman_fixed_32_32_t = int64_t;
alias 	pixman_fixed_48_16_t = pixman_fixed_32_32_t;
alias 		pixman_fixed_1_31_t = uint32_t;
alias 		pixman_fixed_1_16_t = uint32_t;
alias 			pixman_fixed_16_16_t = int32_t;
...
enum pixman_fixed_to_int(f)		= (cast(int) ((f) >> 16));
enum pixman_int_to_fixed(i)		= cast(pixman_fixed_t) (cast(uint32_t) (i) << 16);
enum pixman_fixed_to_double(f)	= cast(double) ((f) / cast(double) pixman_fixed_1);
enum pixman_double_to_fixed(d)	= cast(pixman_fixed_t) ((d) * 65536.0);
enum pixman_fixed_frac(f)		= ((f) & pixman_fixed_1_minus_e);
enum pixman_fixed_floor(f)		= ((f) & ~pixman_fixed_1_minus_e);
enum pixman_fixed_ceil(f)		= pixman_fixed_floor ((f) + pixman_fixed_1_minus_e);
enum pixman_fixed_fraction(f)	= ((f) & pixman_fixed_1_minus_e);
enum pixman_fixed_mod_2(f)		= ((f) & (pixman_fixed1 | pixman_fixed_1_minus_e));
enum pixman_max_fixed_48_16		= (cast(pixman_fixed_48_16_t) 0x7fffffff);
enum pixman_min_fixed_48_16		= (-(cast(pixman_fixed_48_16_t) 1 << 31));

/*
 * Misc structs
 */
alias pixman_color_t = pixman_color;
alias pixman_point_fixed_t = pixman_point_fixed;
alias pixman_line_fixed_t = pixman_line_fixed;
alias pixman_vector_t = pixman_vector;
alias pixman_transform_t = pixman_transform;
